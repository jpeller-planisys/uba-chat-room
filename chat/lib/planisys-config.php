...
$config['langNames'] = array('es' => 'Castellano');
...
$config['inactiveTimeout'] = 200;
// Interval in minutes to check for inactive users:
$config['inactiveCheckInterval'] = 200;
...
$config['showLogoutButton'] = false;
$config['showStyleSelection'] = true;
